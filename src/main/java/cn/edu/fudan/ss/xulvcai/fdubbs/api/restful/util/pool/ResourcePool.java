 ...
 * @author hidennis
 * @param <T> The type of resource that this pool manages
 */
public interface ResourcePool<T> {
	 ...
	 * @param resource Resource that returned back into the pool
	 */
	public void returnResource(T resource);
	
	/**
	 * Check if there is any available resource exists in the pool
	 * @return <code>true</code> if any available resource exists in the pool, <code>false</code> otherwise
	 */
