...
public interface DomParsingHelper {
	 ...
	 * @return the text value of the node specified by 'xpathExpression', or
	 *         'null' if the node not exist
	 * @throws Exception
	 */
	 ...
	 * 
	 * @param xpathExpression
	 * @return the number of nodes that match 'xpathExpression', or zero(0) if
	 *         the node not exist
	 */
	 ...
	 * @param xpathOfNode
	 * @param index
	 * @return the attribute value of the attribute 'attributName' of node
	 *         specified by 'xpathExpression' and 'index', or 'null' if the
	 *         attribute/node not exist
	 */
	 ...
	 * @param xpathExpression
	 * @param index
	 * @return the text value of the node specified by 'xpathExpression' and
	 *         'index', or 'null' if the nodes not exist
	 */
