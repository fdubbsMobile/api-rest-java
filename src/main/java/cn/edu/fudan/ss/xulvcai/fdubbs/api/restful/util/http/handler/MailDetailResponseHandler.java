...
public class MailDetailResponseHandler implements ResponseHandler<MailDetail> {
	...
	private static Logger logger = LoggerFactory.getLogger(MailDetailResponseHandler.class);
	...
	public MailDetailResponseHandler(String authCode, int mailNum, String mailLink) {
	...
	public MailDetail handleResponse(HttpResponse response)
		...
		MailDetail detail = constructMailDetail(domParsingHelper, mailNum, mailLink);
		return detail;
	}
	...
	private MailDetail doLoginAndGetMailDetail() throws ClientProtocolException, IOException {
