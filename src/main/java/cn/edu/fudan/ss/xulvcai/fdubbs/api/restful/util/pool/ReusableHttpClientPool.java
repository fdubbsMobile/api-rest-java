...
/**
 * A generic ReusableHttpClient pool implementation based on factories.
...
public class ReusableHttpClientPool implements ResourcePool<ReusableHttpClient> {
    ...
    public ReusableHttpClientPool(ResourceFactory<ReusableHttpClient> httpClientFactory, int capacity) {
