...
public class UserInfoResponseHandler  implements ResponseHandler<UserInfo>{
	...
	private static Logger logger = LoggerFactory.getLogger(UserInfoResponseHandler.class);
	...
	public HttpGet getUserInfoGetRequest() {
		...
		if (uri == null) {
			...
			builder.append("http://").append(BBSHostConstant.getHostName()).append("/bbs/qry");
			builder.append("?u=");
	...
	private UserInfo doLoginAndGetUserInfo() throws ClientProtocolException, IOException {
